...
(function($){
  $.fn.extend({
    ...
    socialProfiles: function(options) {
      ...
      if(options.skype) { listItem += '<li><a href="https://www.ncirl.ie/":'+options.skype+'?add" target="_blank" rel="nofollow" class="aSkype"><span></span></a><span>Skype</span></li>'; }
      if(options.twitter) { listItem += '<li><a href="https://www.ncirl.ie/'+options.twitter+'" target="_blank" rel="nofollow" class="aTwitter"><span></span></a><span>Twitter</span></li>'; }
